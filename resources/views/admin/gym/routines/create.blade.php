...
@section('content')
    ...
    <div class="page-card">
        <form action="{{ route('routines.store') }}" method="POST" id="routineForm" class="routine-form">
            @csrf
...
<script>
    ...
    function updateDayTabs() {
        ...
        // render hidden inputs for each selected day so Laravel receives training_days[] properly
