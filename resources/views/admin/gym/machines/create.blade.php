...
<head>
    ...
    <title>Crear Máquina - GymUdec</title>
        ...
        <div class="form-container">
            <form method="POST" action="{{ route('machines.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" required value="{{ old('name') }}" placeholder="Ej: Trotadora, Press de Banca...">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="image_url" name="image_url" value="{{ old('image_url') }}" placeholder="Ej: https://example.com/maquina.jpg">
                </div>
